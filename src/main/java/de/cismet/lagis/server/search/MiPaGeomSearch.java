...
public class MiPaGeomSearch extends GeomServerSearch implements RestApiCidsServerSearch, ConnectionContextStore {
    ...
    private static final String SQL_TEMPLATE =
        "SELECT %s FROM %s, geom WHERE geom.id = mipa.fk_geom AND ST_intersects(GeomFromText('%s', %s), geom.geo_field) AND (mipa.vertragsende IS NULL OR mipa.vertragsende > now())";
